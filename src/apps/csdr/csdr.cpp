...
int Cli::main(int argc, char** argv) {
    ...
    app.add_subcommand(std::shared_ptr<CLI::App>(new SnrCommand()));
    app.add_subcommand(std::shared_ptr<CLI::App>(new SnrSquelchCommand()));
    ...
    app.add_subcommand(std::shared_ptr<CLI::App>(new FskUartDecodeCommand()));
    ...
    app.add_subcommand(std::shared_ptr<CLI::App>(new SitorBDecodeCommand()));
